...
con=squeeze(mean(flcon,2));
inc=squeeze(mean(flinc,2));
con11=[con(1:10,:)+con(11:20,:)+con(21:30,:)]/3;
inc11=[inc(1:10,:)+inc(11:20,:)+inc(21:30,:)]/3;
[con11]=nirsChannelCombine(con11);
[inc11]=nirsChannelCombine(inc11);


con=mean(con');
inc=mean(inc');
con=[con(1:10); con(11:20); con(21:30)];
inc=[inc(1:10); inc(11:20); inc(21:30)];
con=mean(con)';
inc=mean(inc)';
